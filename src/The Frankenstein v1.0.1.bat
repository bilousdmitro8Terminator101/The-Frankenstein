...
title The Frankenstein v.1.0.1
color 0B

:menu
cls 
echo ====================================================
echo    The Frankenstein v.1.0.1 Main menu 
echo ====================================================
echo. 
...
echo Insert number [21] = Task Scheduler
echo Insert number [22] = WinUtil (Internet connection required to run)
echo.
echo ====================================================
echo Press [Alt+ENTER] = Full screen mode ON \ OFF
echo Press key [H] = HELP
...
if /I "%choice%"=="21" start taskschd.msc & goto Utilities_console
if /I "%choice%"=="22" powershell -Command "irm christitus.com/win | iex"
...
echo ====================================================
echo. 
echo Insert number [1] = Set Force terminating programs automatically in 5 sec (In case if not request)
echo Insert number [2] = Set Automatically reboot your PC (in case of BSOD)
echo Insert number [3] = Set Automatically restart Explorer (In case if not request)
echo Insert number [4] = Set Improving security (Shutdown will be longer)
echo Insert number [5] = Set Improving compatibility (For old programms and games)
echo Insert number [6] = Enable Default Photo viewer (As Windows 7)
echo Insert number [7] = Add \ remove items in Desktop context menu
echo Insert number [8] = Add \ remove GOD MODE folder (Extended control panel \ analog of classic control panel)
echo Insert number [9] = Disable avto Winlogon (In case if you have more than 1 local user account)
echo Insert number [10] = Hibernation ON \ OFF
echo Insert number [11] = Set High PC performance
echo.
echo ====================================================
echo Press [Alt+ENTER] = Full screen mode ON \ OFF
echo Press key [H] = HELP
