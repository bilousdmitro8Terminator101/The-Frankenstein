...
echo Press key [0] = Hibernation ON \ OFF
echo.
echo ====================================================
echo Press [Alt+ENTER] = Full screen mode ON \ OFF
echo Press key [H] = HELP
...
if /I "%choice%"=="0" goto Hibernation
...
echo - If you need to remove any updates:
echo 1 Open notepad 
echo 2 copy and paste the command: dism /online /remove-package /packagename:
echo 3 copy and paste the update number <Package_for_KBPackagename>
echo 4 Run command prompt as an administrator
echo 5 Copy and paste it to the command prompt
echo 6 Press key <Enter>
pause
goto menu